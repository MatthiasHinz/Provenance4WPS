...
public class UseCase2 {
	public static void main(String[] args) throws Exception {   		
   		...
   		File executeFile = new File("usecase_requests"+File.separator+"request_usecase2_genpop.xml");
   		...
   		File executeFile2 = new File("usecase_requests"+File.separator+"request_usecase2_albatross.xml");
